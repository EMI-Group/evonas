    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            if self.args.dataset == 'kitti':
                ...
                depth_file = sample_path.split()[1]  # yzh
            ...
            if self.mode == 'online_eval':
                ...
                depth_path = os.path.join(gt_path, "./" + sample_path.split()[1])  # maybe need to change
                if self.args.dataset == 'kitti':
                    # depth_path = os.path.join(gt_path, sample_path.split()[0].split('/')[0], sample_path.split()[1])
                    depth_path = os.path.join(gt_path, sample_path.split()[1])  # yzh
