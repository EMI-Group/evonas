...
class CoordAtt(nn.Module):
    def __init__(self, inp, groups=32):
        ...
        self.conv2 = Conv2d(mip, inp, kernel_size=1, stride=1, padding=0)
        self.conv3 = Conv2d(mip, inp, kernel_size=1, stride=1, padding=0)
        # self.conv4 = Conv2d(inp, oup, kernel_size=1, stride=1, padding=0)  # 输入和输出相同通道数，不用
        self.relu = h_swish()
        # 初始化 Conv
