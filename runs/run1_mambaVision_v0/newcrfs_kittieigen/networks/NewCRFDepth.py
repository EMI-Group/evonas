...
class NewCRFDepth(nn.Module):
    ...
    def __init__(self, version=None, inv_depth=False, pretrained=None, 
        ...
        self.mba3 = Block(dim=embed_dim,num_heads=16,counter=-1,transformer_blocks=[],mlp_ratio=4,qkv_bias=True,qk_scale=False,drop=0.,attn_drop=0.,drop_path=0.,layer_scale=None)  # TODO drop_path
        self.mba2 = Block(dim=in_channels[2],num_heads=8,counter=-1,transformer_blocks=[],mlp_ratio=4,qkv_bias=True,qk_scale=False,drop=0.,attn_drop=0.,drop_path=0.,layer_scale=None)  # TODO drop_path
        self.mba1 = Block(dim=in_channels[1],num_heads=4,counter=-1,transformer_blocks=[],mlp_ratio=4,qkv_bias=True,qk_scale=False,drop=0.,attn_drop=0.,drop_path=0.,layer_scale=None)  # TODO drop_path
        self.mba0 = Block(dim=in_channels[0],num_heads=2,counter=-1,transformer_blocks=[],mlp_ratio=4,qkv_bias=True,qk_scale=False,drop=0.,attn_drop=0.,drop_path=0.,layer_scale=None)  # TODO drop_path
        ...
        self.proj_final = nn.Conv2d(in_channels[0], in_channels[0], 3, 1, 1)
